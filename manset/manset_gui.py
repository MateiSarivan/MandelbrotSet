...
class MansetGUI:
    def __init__(self):
        ...
        label_selected_compute_mode = tkinter.Label(frame_selected_compute_mode,
                                                    textvariable=txt_selected_compute_mode, width=30)
        label_selected_cores = tkinter.Label(frame_selected_cores, textvariable=txt_selected_cores, width=30)
        label_selected_no_points = tkinter.Label(frame_selected_no_points,
                                                 textvariable=txt_selected_no_points, width=30)
        ...
        label_selected_compute_mode_value = tkinter.Label(frame_selected_compute_mode,
                                                          textvariable=self.txt_selected_compute_mode_value, width=30)
        label_selected_cores_value = tkinter.Label(frame_selected_cores,
                                                   textvariable=self.txt_selected_cores_value, width=30)
        label_selected_no_points_value = tkinter.Label(frame_selected_no_points,
                                                       textvariable=self.txt_selected_no_points_value, width=30)
        label_saved_experiments_value = tkinter.Label(frame_saved_experiments,
                                                      textvariable=self.txt_saved_experiments_value, width=30)
        ...
        self.scaler_core_no = tkinter.Scale(master=no_cores_frame, from_=0, to=os.cpu_count(),
                                            orient=tkinter.HORIZONTAL, length=130, command=self.update_scale)
        ...
        self.chbox = tkinter.Checkbutton(controls_frame, text='Save Experiment',
