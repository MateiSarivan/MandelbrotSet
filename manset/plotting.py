...
def plot_experiments(file_address, experiments):
    ...
    for experiment in experiments:
        ...
        strings = (strings + str(index) + ": " + experiment["computation_method"] + ", " + str(experiment['number of cores']) + " cores, " + str(int(experiment['no_points'])) + " points per axis, " 
        ...
        plot.imshow(experiment['result'].T, interpolation="nearest",
                                                cmap=plt.cm.hot, extent=[experiment['min_x'], experiment['max_x'], experiment['min_y'], experiment['max_y']])
